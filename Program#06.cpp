...
public:
    ...
    void search() {
        ...
        case 2: {
            ...
            // Sort the queue by Tour ID for binary search
            sort(queue + front, queue + rear + 1, [](const Tour& a, const Tour& b) {
            ...
            while (left <= right) {
                ...
                if (queue[mid].Tour_ID == id) {
                    foundIndex = mid;
                    break;
                } else if (queue[mid].Tour_ID < id) {
                    left = mid + 1;
                } else {
                    right = mid - 1;
                }
            ...
            if (foundIndex != -1) {
                ...
                cout << "\033[34mTour ID: \033[0m" << queue[foundIndex].Tour_ID << endl;
                cout << "\033[34mOrigin: \033[0m" << queue[foundIndex].Origin << endl;
                cout << "\033[34mDestination: \033[0m" << queue[foundIndex].Destination << endl;
                cout << "\n\033[34mPassenger Name: \033[0m" << queue[foundIndex].Passenger_Name << endl;
                cout << "\033[34mPassenger Age: \033[0m" << queue[foundIndex].Passenger_Age << endl;
                cout << "\n\033[34mTotal Price: ₹\033[0m" << queue[foundIndex].Price << endl;
                cout << "-----------------------------\n";
            } else {
